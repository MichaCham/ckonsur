...
public class App {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Mode de persistence : " + properties.getProperty("persistence"));
        ...
        while (true) {
            ...
            while (actionARealiser.equals("1") == false && actionARealiser.equals("2") == false
                    && actionARealiser.equals("3") == false && actionARealiser.equals("4") == false
                    && actionARealiser.equals("9") == false) {
            ...
            if (actionARealiser.equals("1")) {
                ...
                test.afficherCreneaux(Integer.parseInt(partiesdates[2]), Integer.parseInt(partiesdates[1]),
                        Integer.parseInt(partiesdates[0]));
                ...
                try {
                    ...
                    test.prendreRdv(timeStamp,nomveto,nomcli);
                } catch (Exception e) {
